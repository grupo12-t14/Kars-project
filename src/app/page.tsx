    ...
    <main className="flex min-h-screen flex-col items-center justify-between">
      ...
      <div className="relative bg-gray-500 w-full">
        ...
        <div className="absolute mt-[-400px] left-1/2 transform -translate-x-1/2 w-[90%] md:min-w-[700px] md:w-[85%] md:flex md:justify-between md:items-center">
          <div className="w-full md:min-w-[700px] md:w-[45%]">
          ...
          <div
            id="total infos user"
            className="rounded w-full mt-[32px] md:min-w-[700px] md:w-[10%] bg-red-600"
          >
              ...
              <div className="mt-[32px] grid grid-cols-3 gap-4">
                {images.map((fotos, index) => {
                  return (
                    <figure
                      key={index}
                      className="bg-gray-700 w-[100px] h-[100px] p-2 flex justify-center items-center"
                    >
                      <Image
                        src={fotos}
                        width={100}
